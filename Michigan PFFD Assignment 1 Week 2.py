#At the halfway point during the Rio Olympics, the United States had 70 medals, Great Britain had 38
#medals, China had 45 medals, Russia had 30 medals, and Germany had 17 medals. Create a dictionary
#assigned to the variable medal_count with the country names as the keys and the number of medals the
...
#point in the 2016 Rio Olympics. Using dictionary mechanics, assign the medal count value for "Belarus"
...
#Use dictionary mechanics to find the number of golds Chile has won, and assign that number to the variable name
...
#Provided is a dictionary called US_medals which has the first 70 medals that the United States has won in 2016,
