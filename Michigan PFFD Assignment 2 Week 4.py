...
#is True, and an optional dictionary, called dict1, whose default value is {2:3, 4:5, 6:8}.
...
#Write the function checkingIfIn so that when the second parameter is True, it checks to see if the first
#parameter is a key in the third parameter; if it is, return True, otherwise return False.
...
#Follow the instructions in the active code window for specific variable assignments.
